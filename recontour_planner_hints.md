...
### Compare ad spend across Google, Amazon, and other sources. Break down conversion, CPA, and ROAS. Suggest optimizations.
{
    "Plan": {
        "1": {
            "Request": "Extract ad spend data for Google Ads campaigns for the last quarter.",
            "DataNeeded": "google_ads.gads_campaign_report",
            "RequiresCode": "False",
            "RequiresQuery": "True"
        },
        "2": {
            "Request": "Extract ad spend data for Amazon Ads campaigns for the last quarter.",
            "DataNeeded": "amazon_advertising.amz_ads_metrics_per_campaign_type",
            "RequiresCode": "False",
            "RequiresQuery": "True"
        },
        "3": {
            "Request": "Extract ad spend data for non-channel PPC campaigns for the last quarter.",
            "DataNeeded": "non_channels_ppc.non_channels_ppcmetrics",
            "RequiresCode": "False",
            "RequiresQuery": "True"
        },
        "4": {
            "Request": "Calculate conversion rates, CPA, and ROAS for Google Ads campaigns for each brand.",
            "DataNeeded": "1",
            "RequiresCode": "True",
            "RequiresQuery": "False"
        },
        "5": {
            "Request": "Calculate conversion rates, CPA, and ROAS for Amazon Ads campaigns for each brand.",
            "DataNeeded": "2",
            "RequiresCode": "True",
            "RequiresQuery": "False"
        },
        "6": {
            "Request": "Calculate conversion rates, CPA, and ROAS for non-channel PPC campaigns for each brand.",
            "DataNeeded": "3",
            "RequiresCode": "True",
            "RequiresQuery": "False"
        },
        "7": {
            "Request": "Compare the calculated metrics across Google, Amazon, and non-channel sources to identify underperforming channels.",
            "DataNeeded": "4, 5, 6",
            "RequiresCode": "True",
            "RequiresQuery": "False"
        },
        "8": {
            "Request": "Suggest optimizations for the underperforming channels based on the comparison.",
            "DataNeeded": "7",
            "RequiresCode": "False",
            "RequiresQuery": "False"
        }
